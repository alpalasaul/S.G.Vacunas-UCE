...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/sgv/login", "/usuario/actualizarToken", "/carnet/descargarCarnert/**", "/carnet/send").permitAll() // para la autenticacion se debe de permitir cualquier peticion, borrar el endpoint de plan luego
